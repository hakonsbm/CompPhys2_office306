		...
		\subsubsection{Derivatives of single particle wavefunctions}
			...
			\begin{center}
				...
				\\	\hline
					...
					&
					\( \frac{\alpha e^{- \frac{\alpha r_{i}}{2}}}{4 r_{i}} \left(\alpha r_{i} - 4\right) \vb{r_i} \)
					&
				...
				\\	\hline
					...
					&
					\( - \frac{\alpha  }{r_{i}} e^{- \frac{\alpha r_{i}}{2}} \left(\frac{\alpha x_{i} \vb{r_i}}{2} -  r_i\vu{i} \right) \)%- \frac{\alpha e^{- \frac{\alpha r_{i}}{2}}}{2 r_{i}} \left( \alpha x_{i}\vb{r_i} - 2 r_{i}\right) \)
					&
					\( \frac{\alpha^{2} x_{i}}{4 r_{i}} \left(\alpha r_{i} - 8\right) e^{- \frac{\alpha r_{i}}{2}} \)
				\\	\hline
					\(\psi_{2Py}\)
					&
					\( \alpha y_{i} e^{- \frac{\alpha r_{i}}{2}} \)
					&
					\( - \frac{\alpha e^{- \frac{\alpha r_{i}}{2}}}{2 r_{i}} \left( \alpha y_{i} \vb{r_i} - 2 r_{i}\right) \)
					&
					\( \frac{\alpha^{2} x_{i}}{4 r_{i}} \left(\alpha r_{i} - 8\right) e^{- \frac{\alpha r_{i}}{2}} \)
				\\	\hline
					\(\psi_{2Pz}\)
					&
					\( \alpha z_{i} e^{- \frac{\alpha r_{i}}{2}} \)
					&
					\( - \frac{\alpha e^{- \frac{\alpha r_{i}}{2}}}{2 r_{i}} \left(\alpha z_{i}\vb{r_i} - 2 r_{i}\right) \)
					&
					\( \frac{\alpha^{2} x_{i}}{4 r_{i}} \left(\alpha r_{i} - 8\right) e^{- \frac{\alpha r_{i}}{2}} \)
				\\ \toprule
				\end{tabular}
...
\section{Conclusions}
	...
	Taking a look at \ref{tab:energyReference} it is apparent that the results are quite precise. In the case of Beryllium, the experimental value is less than $2\%$ higher than the computational one, while for Neon, the difference is even less at barely $1\%$. These results are very good considering the amount of resources that went into calculating them: a simple standard PC and a handful of hours were enough. Considering that a relatively simple and very well tested method was used to obtain these results it is very easy to see why VMC is so popular for solving quite complicated problems like calculating the ground state energies of non-trivial quantum mechanical systems.

	\begin{align}
- \frac{\alpha^{2} x_{i} y_{i}}{2 r_{i}} e^{- \frac{\alpha r_{i}}{2}} - \frac{\alpha^{2} x_{i} z_{i}}{2 r_{i}} e^{- \frac{\alpha r_{i}}{2}} - \frac{\alpha e^{- \frac{\alpha r_{i}}{2}}}{2 r_{i}} \left(\alpha x_{i}^{2} - 2 r_{i}\right)	\end{align}
