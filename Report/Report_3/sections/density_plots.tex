\subsection{Charge density plots}
	...
	\subsubsection{Beryllium Molecule}
		...
		\begin{figure}
			\centering \includegraphics[width=0.32\linewidth]{../figures/used/ChargeDensityBerylliumTwo}
			\centering \includegraphics[width=0.32\linewidth]{../figures/used/OneBodyDensityBerylliumTwo}
			\centering \includegraphics[width=0.32\linewidth]{../figures/used/OneBodyDensityElectronsBerylliumTwo}
			\protect\caption{The left figure is the radial distribution of the Beryllium Molecule from the origo, where both nuclei where placed \(R = 4.63 a.u\) way from each other on the \(z\) axis. The figure in the center is shows a slice of the \(xz\) plane with with of \(1.0\) a.u. On the right figure one body denseties off each of the electrons is shown. The run used had $10^6$ VMC cycles. The consentration of the charge density is very sharp around the two nuclei.}
