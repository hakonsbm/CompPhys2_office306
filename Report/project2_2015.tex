...
\appendix
	...
	\section{Local Energies with the Jastrow Factor}
		...
		\begin{align}
			-\frac{1}{2\Psi_T}\pdv{\Psi_T}{r_i} \frac{ 2 }{ r_i } &= -\frac{1}{\Psi_S\Psi_J} \frac{1}{r_i} \left( \pdv{\Psi_S}{r_i}\Psi_J + \Psi_S\pdv{\Psi_J}{r_i} \right)
			\intertext{Since the correlations terms of the trialfunctions are of the form \( \Psi_J = \exp{\frac{r_{ij}}{2(1+\beta r_{ij})} } \) we change the derivative factor \[ \pdv{\Psi_J}{r_i}  = \pdv{r_{ij}}{r_i} \pdv{\Psi_J}{r_{ij}} = \pdv{ \vb{r_i} - \vb{r_j} } {} \]}
		\end{align}
