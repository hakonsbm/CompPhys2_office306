...
\section{Methods}
	...
	\subsection{Verification of the model}
		...
		\subsubsection{Verification of the Padè-Jastrow part.}
			...
			Let us consider the gradient ratio of the Padè-Jastrow factor in Helium, \(\nabla\frac{\psi_C(\vb{r}_{12})}{\psi_C(\vb{r}_{12})}\) with \(\psi_C(\vb{r_{12}}) = e^{\frac{r_{12}}{2(1+\beta r_{12})}}\). Using the results from equation \eqref{eq:gradient_ratio_Jastrow} we get
...
\section{Results and discussion}
	...
	Reference to table \ref{tab:energyReference}.
	...
	\subsection{Speedup with MPI}
		...
		\begin{figure}
		\centering \includegraphics[width=0.45\linewidth]{../source/outfiles/processor_number_time_comparison}
